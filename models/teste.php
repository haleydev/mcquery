...
{ 
    ...
    {            
        return (new Model)->table('teste')->select($arguments);        
    }
    ...
    {            
        return (new Model)->table('teste')->insert($arguments);        
    }
    ...
    */
    ...
    {            
        return (new Model)->table('teste')->update($arguments);        
    }
    ...
    */    
    ...
    {            
        return (new Model)->table('teste')->delete($arguments);        
    }
}