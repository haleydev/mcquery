    ...
    public function class(string $string)
    {
        ...
        foreach ($local as $key) {
            if ($count < $total - 1) {
                ...
                if (!file_exists(ROOT."/app/Classes/$folder")) {
                    mkdir(ROOT."/app/Classes/$folder", 0777, true);
                }
            }
            $count++;
        }
        ...
        if ($nameclass == "") {
            ...
            $confirm = true;
            if (file_exists(ROOT."/app/Classes/$folder$nameclass.php")) {
            ...
            if ($confirm == true) {
                file_put_contents(ROOT.'/app/Classes/' . $folder . '' . $nameclass . '.php', $file);
